...
import {
    Sparkles, Plus, PawPrint, Edit2, Trash2
} from 'lucide-react';
import { Service } from '../types';
// import { googleService } from '../services/googleService';

export const ServiceManager: React.FC<{ services: Service[]; onAddService: (s: Service) => void; onDeleteService: (id: string) => void; onSyncServices: (silent: boolean) => void; }> = ({ services, onAddService, onDeleteService, onSyncServices }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            if (editingService) {
                alert("Edição de serviços será habilitada em breve.");
            } else {
    ...
    const handleDelete = async (service: Service) => {
        ...
        setContextMenu(null);
        // Legacy Google Sheet delete removed
